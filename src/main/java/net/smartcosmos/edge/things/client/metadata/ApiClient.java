package net.smartcosmos.edge.things.client.metadata;
...
import net.smartcosmos.edge.things.client.metadata.auth.ApiKeyAuth;
import net.smartcosmos.edge.things.client.metadata.auth.Authentication;
import net.smartcosmos.edge.things.client.metadata.auth.HttpBasicAuth;
import net.smartcosmos.edge.things.client.metadata.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://https://objects.smartcosmos.net/";
    ...
    */
    ...
    private ClientResponse getAPIResponse(
        String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams,
        String accept, String contentType, String[] authNames) throws ApiException {
    ...
    public <T> T invokeAPI(
        String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, Object>
        formParams, String accept, String contentType, String[] authNames, GenericType<T> returnType) throws ApiException {
