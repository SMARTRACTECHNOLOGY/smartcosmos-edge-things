...
* <<read4, Read - `POST /findByKeyValuePairs?page={pageNumber}&size={pageSize}`>>
...
[[read4]]
==== Find by Key-Value Pairs - `POST /findByKeyValuePairs?page={pageNumber}&size={pageSize}`

----
POST /findByKeyValuePairs?page=1&size=100
----
[source,json]
----
{
