= REST Implementations for Things RDAO
...
* <<read3, Read - `POST /findByUrns`>>
* <<read4, Read - `GET /findAll?page={pageNumber}&size={pageSize}`>>
...
The fields `name`, `description` and `fun` will be added as metadata for this thing.
...
[[read4]]
==== Find all - `GET /findAll?page={pageNumber}&size={pageSize}`

----
GET /findAll?page=0&size=100
----
.Response
----
200 OK
