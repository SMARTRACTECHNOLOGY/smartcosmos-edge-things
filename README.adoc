...
* <<read3, Read - `POST /?fields={keyNames}`>>
* <<read4, Read - `GET /?fields={keyNames}&page={pageNumber}&size={pageSize}`>>
...
[[read3]]
==== Find by URNs - `POST /?fields={keyNames}`
...
[[read4]]
==== Find all - `GET /?fields={keyNames}&page={pageNumber}&size={pageSize}`
